...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
          ...
          System.out.println("\n");
          switch (pilihan) {
            case 1: loopMethod(teknologi, "Teknologi"); break;
            case 2: loopMethod(filsafat, "Filsafat"); break;
            case 3: loopMethod(sejarah, "Sejarah"); break;
            case 4: loopMethod(agama, "Agama"); break;
            case 5: loopMethod(psikologi, "Psikologi"); break;
            case 6: loopMethod(politik, "Politik"); break;
            case 7: loopMethod(fiksi, "Fiksi"); break;
